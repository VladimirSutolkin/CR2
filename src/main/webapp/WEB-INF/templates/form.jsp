    ...
    <form th:method="POST" th:action="@{/users}" th:object="${user}">
        ...
        <div class="form-row">
            <div class="col-md-6 mb-3">
                ...
                <input type="text" class="form-control" id="name" th:field="*{firstName}" th:value="*{getFirstName()}"
            ...
            <div class="col-md-6 mb-3">
                ...
                <input type="text" class="form-control" id="last_name" th:field="*{lastName}"
                       th:value="*{getLastName()}" placeholder="Enter last name">
            </div>
        </div>
        <div class="form-row">
            <div class="col-md-6 mb-3">
                <label for="email">Email</label>
                <input type="text" class="form-control" id="email" th:field="*{email}" th:value="*{getEmail()}"
            ...
            <div class="col-md-6 mb-3">
                ...
                <input type="password" class="form-control" id="password" th:field="*{password}"
                       th:value="*{getPassword()}" placeholder="Enter password" required>
